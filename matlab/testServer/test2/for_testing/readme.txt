test2 for MATLAB Production Server

Before you can use the functions packaged by the compiler, you need to do the following:
* Deploy test2.ctf to a server instance
* Develop a client application to access the functions.

1. Deploy test2.ctf

1.1 Prerequisites to Deployment
Before you can deploy test2.ctf, you need a server instance to host it. The server 
instance must be configured to have access to MATLAB Runtime 9.7.
* If you do not have a server instance created, see: 
  https://www.mathworks.com/help/mps/server/creating-a-server.html
* If you do not have version 9.7 of the MATLAB Runtime installed, download the installer 
  from the MATLAB Runtime page at: 
  https://www.mathworks.com/products/compiler/mcr/index.html
* If you need to configure the server instance to use the version 9.7 of the MATLAB 
  Runtime, see: 
  https://www.mathworks.com/help/mps/server/customize-the-configuration-file.html

1.2 test2.ctf Deployment
To deploy test2.ctf, copy it into the server instance's `auto_deploy` folder. The server 
