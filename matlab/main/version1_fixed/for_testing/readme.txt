version1_fixed for MATLAB Production Server

Before you can use the functions packaged by the compiler, you need to do the following:
. Deploy version1_fixed.ctf to a server instance
. Develop a client application to access the functions.

1. Deploy version1_fixed.ctf

1.1 Prerequisites to Deployment
Before you can deploy version1_fixed.ctf you need a server instance to host it. The 
...
1.2 version1_fixed.ctf Deployment
To deploy version1_fixed.ctf, copy it into the server instance's `auto_deploy` folder. 
