main_function_v4 for MATLAB Production Server

Before you can use the functions packaged by the compiler, you need to do the following:
. Deploy main_function_v4.ctf to a server instance
. Develop a client application to access the functions.

1. Deploy main_function_v4.ctf

1.1 Prerequisites to Deployment
Before you can deploy main_function_v4.ctf you need a server instance to host it. The 
...
1.2 main_function_v4.ctf Deployment
To deploy main_function_v4.ctf, copy it into the server instance's `auto_deploy` folder. 
