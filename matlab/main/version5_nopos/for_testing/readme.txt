version5_nopos for MATLAB Production Server

Before you can use the functions packaged by the compiler, you need to do the following:
. Deploy version5_nopos.ctf to a server instance
. Develop a client application to access the functions.

1. Deploy version5_nopos.ctf

1.1 Prerequisites to Deployment
Before you can deploy version5_nopos.ctf you need a server instance to host it. The 
...
1.2 version5_nopos.ctf Deployment
To deploy version5_nopos.ctf, copy it into the server instance's `auto_deploy` folder. 
