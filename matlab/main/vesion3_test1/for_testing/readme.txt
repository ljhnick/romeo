vesion3_test1 for MATLAB Production Server

Before you can use the functions packaged by the compiler, you need to do the following:
. Deploy vesion3_test1.ctf to a server instance
. Develop a client application to access the functions.

1. Deploy vesion3_test1.ctf

1.1 Prerequisites to Deployment
Before you can deploy vesion3_test1.ctf you need a server instance to host it. The server 
instance must be configured to have access to MATLAB Runtime 9.5.
...
1.2 vesion3_test1.ctf Deployment
To deploy vesion3_test1.ctf, copy it into the server instance's `auto_deploy` folder. The 
